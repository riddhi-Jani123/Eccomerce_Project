                  ...
                  <div id="main-nav" class="stellarnav d-flex justify-content-end right">
                    <ul class="menu-list">
                      ...
                      <li class="menu-item has-sub">
                        <a href="index.jsp" class="item-anchor d-flex align-item-center" data-effect="Home">Home<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="index.jsp" class="item-anchor">Home</a></li>
                          <li><a href="home2.html" class="item-anchor">Home v2<span class="text-primary"> (PRO)</span></a></li>
                        </ul>
                      </li>

                      <li><a href="about.jsp" class="item-anchor" data-effect="About">About</a></li>

                      <li class="menu-item has-sub">
                        <a href="shop.jsp" class="item-anchor d-flex align-item-center" data-effect="Shop">Shop<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="shop.jsp" class="item-anchor">Shop</a></li>
                          ...
                          <li><a href="cart.jsp" class="item-anchor">Cart<span class="text-primary"> (PRO)</span></a></li>
                      ...
                      <li class="menu-item has-sub">
                        <a href="blog.jsp" class="item-anchor d-flex align-item-center" data-effect="Blog">Blog<i class="icon icon-chevron-down"></i></a>
                        <ul class="submenu">
                          <li><a href="blog.jsp" class="item-anchor">Blog</a></li>
                          ...
                          <li><a href="single-post.jsp" class="item-anchor">Single post</a></li>
                        </ul>
                      </li>

                      <li><a href="contact.jsp" class="item-anchor" data-effect="Contact">Contact</a></li>
        ...
        <div class="row">
          <div class="col-md-4">
            <div class="post-image zoom-effect">
              <a href="#"><img src="../static/images/post-img1.jpg"></a>
            </div>
            <div class="caption text-center">Sample Image</div>
          </div>
          <div class="col-md-4">
            <figure>
              <a href="../static/images/post-img2.jpg" rel="gallery" title="Clothing is your personality" class="gallery cboxElement">
                <img src="../static/images/post-img2.jpg" alt="Light Box">
              </a>
          ...
          <div class="col-md-4">
            <div class="jarallax min-height300">
                <img src="../static/images/post-img3.jpg" alt="" class="jarallax-img">
            </div>
        ...
        <div class="row">
          <div class="col-md-12">
            ...
            <figure class="align-right">
              <img src="../static/images/insta-image1.jpg" alt="post">
            </figure>
            <p>
            ...
            <div class="col-lg-3 col-md-6 col-sm-6">
              <div class="footer-menu">
                ...
                <ul class="menu-list list-unstyled">
                  ...
                  <li class="menu-item">
                    <a href="blog.jsp">Our Journals</a>
                  </li>
                  <li class="menu-item">
                    <a href="#">Careers</a>
                  </li>
