    ...
    <div class="main-content d-flex flex-wrap padding-large">
      <div class="container">
        <div class="row">
          <div class="col-md-6">
            <div class="post-meta">
              <span class="post-date">Feb 22, 2023</span> / <a href="blog.jsp" class="blog-categories">Fashion</a>
            </div>
            <h1 class="page-title">Top 10 Casual Look Ideas To Dress Up Your Kids</h1>
            <div class="feature-image">
              <img src="../static/images/single-image2.jpg" alt="post image" class="jarallax-img">
            </div>
          </div>
          <div class="col-md-6">
            ...
            <div class="comments-wrap">
              ...
              <div class="comment-list">
                <article class="d-flex">
                  <img src="../static/images/review-image1.jpg" alt="default" class="commentor-image">
                ...
                <div class="child-comments">
                  <article class="d-flex">
                    <img src="../static/images/review-image2.jpg" alt="sara" class="commentor-image">
                    <div class="author-post">
                      <div class="comment-meta">
